...
Main(){
	...
	frame1 = new JFrame("Notepad App");
  frame1.setBackground(new Color(63,81,181));
  ...
  maintext.setBackground( new Color(35,43,42) );
...
JFileChooser j = new JFileChooser("f:");
     ...
     if (r == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(frame1, evt.getMessage());
                }
            }
            // If the user cancelled the operation
            else
                JOptionPane.showMessageDialog(frame1, "the user cancelled the operation");
        }
